          ...
          <div className="min-h-[100dvh] h-full flex flex-col after:flex-1">
            ...
            <div className="px-4 py-8">
              <div className="max-w-md mx-auto">
                ...
                <h1 className="text-3xl text-gray-800 dark:text-gray-100 font-bold mb-6">직책을 선택해주세요</h1>
                {/* Form */}
                <form>
                  <div className="sm:flex space-y-3 sm:space-y-0 sm:space-x-4 mb-8">
                    <label className="flex-1 relative block cursor-pointer">
                      ...
                      <div className="h-full text-center bg-white dark:bg-gray-800 px-4 py-6 rounded-lg border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm transition">
                        ...
                        <div className="font-semibold text-gray-800 dark:text-gray-100 mb-1">담당자</div>
                        <div className="text-sm">조직에 소속된 담당자</div>
                      </div>
                    ...
                    <label className="flex-1 relative block cursor-pointer">
                      ...
                      <div className="h-full text-center bg-white dark:bg-gray-800 px-4 py-6 rounded-lg border border-gray-200 dark:border-gray-700/60 hover:border-gray-300 dark:hover:border-gray-600 shadow-sm transition">
                        ...
                        <div className="font-semibold text-gray-800 dark:text-gray-100 mb-1">보직장</div>
                        <div className="text-sm">조직를 관리하는 관리자</div>
                      </div>
                      <div className="absolute inset-0 border-2 border-transparent peer-checked:border-violet-400 dark:peer-checked:border-violet-500 rounded-lg pointer-events-none" aria-hidden="true"></div>
                    </label>
                  </div>
                  <div className="flex items-center justify-between space-x-6 mb-8">
                    <div>
                      <div className="font-medium text-gray-800 dark:text-gray-100 text-sm mb-1">조직도에 표기되지 않은 직책를 가지고 계신가요?</div>
                      <div className="text-xs">PL/TL/셀장</div>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <Link className="text-sm underline hover:no-underline" href="/onboarding-01">&lt;- 이전</Link>
                    <Link className="btn bg-gray-900 text-gray-100 hover:bg-gray-800 dark:bg-gray-100 dark:text-gray-800 dark:hover:bg-white ml-auto" href="/onboarding-03">다음으로 -&gt;</Link>
                  </div>
                </form>
