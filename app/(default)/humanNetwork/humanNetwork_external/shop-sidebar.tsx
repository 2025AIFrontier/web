    ...
    <div>
      <div className="bg-white dark:bg-gray-800 shadow-sm rounded-xl p-5 min-w-[15rem]">
        <div className="grid md:grid-cols-2 xl:grid-cols-1 gap-6">
          ...
          {/* Price Range */}
          <div>
            <div className="text-sm text-gray-800 dark:text-gray-100 font-semibold mb-3">거래 실적 기준</div>
            <label className="sr-only">Price</label>
            <select className="form-select w-full">
              <option>A 억 이상</option>
              <option>B 억 이상</option>
              <option>C 억 이상</option>
              <option>C 억 미만</option>
            </select>
          </div>
          {/* Group 3 */}
          <div>
