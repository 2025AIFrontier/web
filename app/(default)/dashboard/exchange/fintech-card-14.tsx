  ...
  return (
    <div className="col-span-full bg-white dark:bg-gray-800 shadow-sm rounded-xl">
      <header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700/60">
        <h2 className="font-semibold text-gray-800 dark:text-gray-100">기타 환율</h2>
      </header>
      <div className="p-3">
        {/* Table */}
            ...
            <thead className="text-xs uppercase text-gray-400 dark:text-gray-500 bg-gray-50 dark:bg-gray-700/50 rounded-xs">
              <tr>
                <th className="p-2 whitespace-nowrap">
                  <div className="font-semibold text-left">통화</div>
                </th>
                <th className="p-2 whitespace-nowrap">
                  <div className="font-semibold text-left">국가</div>
                </th>
                <th className="p-2 whitespace-nowrap">
                  <div className="font-semibold text-left">Chart</div>
                </th>
                <th className="p-2 whitespace-nowrap">
                  <div className="font-semibold text-left">환율</div>
                </th>
                <th className="p-2 whitespace-nowrap">
                  <div className="font-semibold text-left">변동 (24h)</div>
                </th>
              </tr>
            </thead>
            {/* Table body */}
              ...
              <tr>
                <td className="p-2 whitespace-nowrap md:w-1/2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-gray-800 dark:text-gray-100 uppercase">CNH</div>
                      <div className="text-xs text-gray-500">중국 위안화 (역내)</div>
                    </div>
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div className="font-normal text-left">중국</div>
                </td>
                <td className="p-2 whitespace-nowrap">
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="text-left">₩190.25</div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div className="text-left text-green-500">+₩0.85 (+0.45%)</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2 whitespace-nowrap md:w-1/2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-gray-800 dark:text-gray-100 uppercase">SGD</div>
                      <div className="text-xs text-gray-500">싱가폴 달러</div>
                    </div>
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div className="font-normal text-left">싱가폴</div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  {/* Chart built with Chart.js 3 */}
                  <div className="w-[96px]">
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="text-left">₩1,025.80</div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div className="text-left text-green-500">+₩3.50 (+0.34%)</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2 whitespace-nowrap md:w-1/2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-gray-800 dark:text-gray-100 uppercase">INR</div>
                      <div className="text-xs text-gray-500">인도 루피</div>
                    </div>
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div className="font-normal text-left">인도</div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  {/* Chart built with Chart.js 3 */}
                  <div className="w-[96px]">
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="text-left">₩16.45</div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div className="text-left text-red-500">-₩0.08 (-0.48%)</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2 whitespace-nowrap md:w-1/2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-gray-800 dark:text-gray-100 uppercase">MXN</div>
                      <div className="text-xs text-gray-500">멕시코 페소</div>
                    </div>
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div className="font-normal text-left">멕시코</div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  {/* Chart built with Chart.js 3 */}
                  <div className="w-[96px]">
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="text-left">₩78.25</div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div className="text-left text-green-500">+₩0.55 (+0.71%)</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2 whitespace-nowrap md:w-1/2">
                  <div className="flex items-center">
                    ...
                    <div>
                      <div className="text-gray-800 dark:text-gray-100 uppercase">GBP</div>
                      <div className="text-xs text-gray-500">영국 파운드</div>
                    </div>
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div className="font-normal text-left">영국</div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  {/* Chart built with Chart.js 3 */}
                  <div className="w-[96px]">
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="text-left">₩1,755.60</div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div className="text-left text-red-500">-₩12.30 (-0.70%)</div>
                </td>
              </tr>
            </tbody>
          </table>
