      ...
      <div className="px-5 pt-5">
        <header>
          <h3 className="text-sm font-semibold text-gray-500 uppercase mb-1">
            <span className="text-gray-800 dark:text-gray-100">VND</span> - 베트남 동
          </h3>
          <div className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-1">₩0.055</div>
          <div className="text-sm">
            <span className="font-medium text-green-600">+₩0.001 (+1.85%)</span> - Today
          </div>
        </header>
      </div>
