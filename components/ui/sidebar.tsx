        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-8 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/dashboard/exchange">
              ...
              {/* Human Network */}
              <SidebarLinkGroup open={segments.includes('human-network')}>
                {(handleClick, open) => {
                  return (
                    <>
                      <a
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className={`shrink-0 fill-current ${segments.includes('human-network') ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-8 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/human-network/employees">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                사외 담당자
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/human-network/contacts">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                사내 담당자 찾기
                              </span>
                            </SidebarLink>
                  ...
                  return (
                    <>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-8 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/community/notice">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                공지
                              </span>
                            </SidebarLink>
                          ...
                          <li className="mb-1 last:mb-0">
                            <SidebarLink href="/community/faqs">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                자주 묻는 질문
                              </span>
                            </SidebarLink>
