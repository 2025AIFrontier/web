    ...
    <Menu as="div" className="relative inline-flex">
      ...
      >
        <div className="pt-0.5 pb-2 px-3 mb-1 border-b border-gray-200 dark:border-gray-700/60">
          <div className="font-medium text-gray-800 dark:text-gray-100">{user ? user.name : 'Guest'}</div>
          <div className="text-xs text-gray-500 dark:text-gray-400 italic">{user ? user.role : 'Not logged in'}</div>
        </div>
